.class public Lorg/pornaway/service/DailyListener;
...
.method public scheduleAlarms(Landroid/app/AlarmManager;Landroid/app/PendingIntent;Landroid/content/Context;)V
    ...
    .line 50
    invoke-static {p3}, Lorg/pornaway/helper/PreferenceHelper;->getUpdateCheckDaily(Landroid/content/Context;)Z
    ...
    invoke-static {v0, v2}, Lorg/pornaway/service/DailyListener;->randInt(II)I
    ...
    invoke-static {v1, v0}, Lorg/pornaway/service/DailyListener;->randInt(II)I
    ...
    invoke-static {v0, v2}, Lorg/pornaway/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)V
...
.method public sendWakefulWork(Landroid/content/Context;)V
    ...
    const-class v4, Lorg/pornaway/service/UpdateService;

    invoke-direct {v2, p1, v4}, Landroid/content/Intent;-><init>(Landroid/content/Context;Ljava/lang/Class;)V

    .line 92
    .local v2, "updateIntent":Landroid/content/Intent;
    const-string v4, "org.pornaway.BACKGROUND_EXECUTION"
    ...
    .line 98
    invoke-static {p1}, Lorg/pornaway/service/ConnectivityReceiver;->enableReceiver(Landroid/content/Context;)V
