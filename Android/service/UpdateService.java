...
.method private showUpdateNotification()V
    ...
    invoke-virtual {p0, v13}, Lorg/pornaway/service/UpdateService;->getString(I)Ljava/lang/String;
    ...
    .line 258
    invoke-virtual {p0, v14}, Lorg/pornaway/service/UpdateService;->getString(I)Ljava/lang/String;
    ...
    .line 261
    .local v8, "when":J
    invoke-virtual {p0}, Lorg/pornaway/service/UpdateService;->getApplicationContext()Landroid/content/Context;
    ...
    invoke-virtual {p0, v10}, Lorg/pornaway/service/UpdateService;->getString(I)Ljava/lang/String;
    ...
    const-class v10, Lorg/pornaway/ui/BaseActivity;
    ...
    .line 275
    iget-object v10, p0, Lorg/pornaway/service/UpdateService;->mNotificationManager:Landroid/app/NotificationManager;
...
.method public doWakefulWork(Landroid/content/Intent;)V
    ...
    .prologue
    .line 103
    iget-object v2, p0, Lorg/pornaway/service/UpdateService;->mService:Landroid/content/Context;

    invoke-static {v2}, Lorg/pornaway/util/Utils;->isInForeground(Landroid/content/Context;)Z
    ...
    .line 104
    invoke-direct {p0}, Lorg/pornaway/service/UpdateService;->showUpdateNotification()V

    .line 107
    :cond_b
    iget-object v2, p0, Lorg/pornaway/service/UpdateService;->mService:Landroid/content/Context;

    iget-object v3, p0, Lorg/pornaway/service/UpdateService;->mService:Landroid/content/Context;
    ...
    iget-object v4, p0, Lorg/pornaway/service/UpdateService;->mService:Landroid/content/Context;
    ...
    .line 107
    invoke-static {v2, v3, v4, v5}, Lorg/pornaway/ui/BaseActivity;->setStatusBroadcast(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;I)V

    .line 110
    invoke-direct {p0}, Lorg/pornaway/service/UpdateService;->checkForUpdates()I
    ...
    .line 114
    invoke-direct {p0}, Lorg/pornaway/service/UpdateService;->cancelUpdateNotification()V
    ...
    iget-boolean v2, p0, Lorg/pornaway/service/UpdateService;->mApplyAfterCheck:Z
    ...
    const-class v3, Lorg/pornaway/service/ApplyService;
    ...
    iget v3, p0, Lorg/pornaway/service/UpdateService;->mNumberOfDownloads:I

    iget v4, p0, Lorg/pornaway/service/UpdateService;->mNumberOfFailedDownloads:I
    ...
    invoke-static {v2, v0, v1}, Lorg/pornaway/helper/ResultHelper;->showNotificationBasedOnResult(Landroid/content/Context;ILjava/lang/String;)V
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    .line 74
    iput-object p0, p0, Lorg/pornaway/service/UpdateService;->mService:Landroid/content/Context;

    .line 76
    const-string v1, "notification"

    invoke-virtual {p0, v1}, Lorg/pornaway/service/UpdateService;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Landroid/app/NotificationManager;

    iput-object v1, p0, Lorg/pornaway/service/UpdateService;->mNotificationManager:Landroid/app/NotificationManager;

    .line 79
    iput-boolean v2, p0, Lorg/pornaway/service/UpdateService;->mBackgroundExecution:Z
    ...
    .line 82
    const-string v1, "org.pornaway.BACKGROUND_EXECUTION"
    ...
    iput-boolean v1, p0, Lorg/pornaway/service/UpdateService;->mBackgroundExecution:Z

    .line 88
    :cond_25
    iput-boolean v2, p0, Lorg/pornaway/service/UpdateService;->mApplyAfterCheck:Z

    .line 89
    iget-boolean v1, p0, Lorg/pornaway/service/UpdateService;->mBackgroundExecution:Z

    if-eqz v1, :cond_3b

    .line 90
    iget-object v1, p0, Lorg/pornaway/service/UpdateService;->mService:Landroid/content/Context;

    invoke-static {v1}, Lorg/pornaway/helper/PreferenceHelper;->getAutomaticUpdateDaily(Landroid/content/Context;)Z
    ...
    iput-boolean v1, p0, Lorg/pornaway/service/UpdateService;->mApplyAfterCheck:Z
