...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Lorg/adaway/util/ScanAdwareLoader;->canceled:Z
...
.method private getAdPackages()Ljava/util/List;
    ...
    iget-boolean v0, v0, Lorg/adaway/util/ScanAdwareLoader;->canceled:Z
    ...
    invoke-interface {v5, v0}, Ljava/util/Set;->add(Ljava/lang/Object;)Z
    :try_end_204
    .catch Ljava/lang/Exception; {:try_start_3c .. :try_end_204} :catch_20b
    ...
    const-string v21, "Scan Adware Exception"

    move-object/from16 v0, v20

    move-object/from16 v1, v21

    invoke-static {v0, v1, v10}, Lorg/adaway/util/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
