...
.method private static tryToCreateSymlink(Landroid/content/Context;)V
    ...
    :try_end_12
    .catch Lorg/adaway/util/CommandException; {:try_start_1 .. :try_end_12} :catch_44
    .catch Lorg/adaway/util/RemountException; {:try_start_1 .. :try_end_12} :catch_62
    ...
    .line 423
    invoke-static {p0}, Lorg/adaway/helper/PreferenceHelper;->getNeverReboot(Landroid/content/Context;)Z
    ...
    .line 398
    sget-object v4, Lorg/adaway/util/Constants;->ANDROID_DATA_HOSTS:Ljava/lang/String;

    invoke-static {v4}, Lorg/adaway/util/ApplyUtils;->createSymlink(Ljava/lang/String;)V
    :try_end_43
    .catch Lorg/adaway/util/CommandException; {:try_start_32 .. :try_end_43} :catch_44
    .catch Lorg/adaway/util/RemountException; {:try_start_32 .. :try_end_43} :catch_62
    ...
    invoke-static {v4}, Lorg/adaway/util/ApplyUtils;->createSymlink(Ljava/lang/String;)V
    :try_end_61
    .catch Lorg/adaway/util/CommandException; {:try_start_4e .. :try_end_61} :catch_44
    .catch Lorg/adaway/util/RemountException; {:try_start_4e .. :try_end_61} :catch_62
