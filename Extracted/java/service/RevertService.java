...
.method private revert(Lorg/sufficientlysecure/rootcommands/Shell;)I
    ...
    invoke-static {v3, v4, p1}, Lorg/adaway/util/ApplyUtils;->copyHostsFile(Landroid/content/Context;Ljava/lang/String;Lorg/sufficientlysecure/rootcommands/Shell;)V
    ...
    iget-object v4, p0, Lorg/adaway/service/RevertService;->mService:Landroid/content/Context;

    invoke-static {v4}, Lorg/adaway/helper/PreferenceHelper;->getCustomTarget(Landroid/content/Context;)Ljava/lang/String;
...
.method public doWakefulWork(Landroid/content/Intent;)V
    ...
    invoke-direct {p0, v2}, Lorg/adaway/service/RevertService;->revert(Lorg/sufficientlysecure/rootcommands/Shell;)I
